...
<div class="data_list">
	...
	<div class="row-fluid" style="padding-top: 20px;">
		...
		<div class="span8">
			<form action="userCenter?action=save" method="post" enctype="multipart/form-data" onsubmit="return checkForm()">
				<table width="100%">
					<tr>
						<td width="20%">头像路径：</td>
					...
					<tr>
						<td>个人昵称：</td>
						<td><input type="text" id="nickName" name="nickName" value="${myuser.nickName }" style="margin-top:5px;height:30px;"/></td>
					</tr>
					<tr>
						<td valign="top">个人心情：</td>
						<td>
							<textarea id="mood" name="mood" rows="10" style="width: 100%">${myuser.mood }		
							</textarea>
						</td>
					</tr>
					<tr>
